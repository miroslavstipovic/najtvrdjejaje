    ...
    <div className="my-6">
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <button
          ...
          className="flex items-center justify-center w-9 h-9 bg-black/60 hover:bg-black/80 text-white rounded-full transition-all"
        ...
        <button
          ...
          className="flex items-center justify-center w-9 h-9 bg-black/60 hover:bg-black/80 text-white rounded-full transition-all"
          aria-label="Podijeli na Telegramu"
        >
          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <button
          ...
          className="flex items-center justify-center w-9 h-9 bg-black/60 hover:bg-black/80 text-white rounded-full transition-all"
          aria-label="Podijeli na Redditu"
        >
          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
